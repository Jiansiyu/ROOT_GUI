...
const Double_t kFrontPlaneShift[kNTotPlanes]={0,0,0,0,0}; // mm; the first element = 0 for the initial plane
const Double_t kBackPlaneShift[kNTotPlanes]={0,0,0,0,0}; // mm; the first element = 0 for the initial plane

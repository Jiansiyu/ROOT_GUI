...
// used for fitting, the pedestal is not that critical, so change the pedestal to const value, used for fitting preset value
  for (int i = 0; i < kMAXADC; i++) {
		PedSigma.push_back(13.0);
